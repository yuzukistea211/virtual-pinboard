...
- **Multiple Pinboards**: Switch seamlessly between separate boards (e.g., Work, Personal, Ideas) with individual note collections, inline renaming, duplicating, and deletion.
- **Pure Canvas Workspace**: Unlimited, distraction-free pure white workspace for your ideas.
...
- **Local Persistence & Backup**: Auto-saves to your browser's `localStorage` with single board and all-boards JSON export/import.
